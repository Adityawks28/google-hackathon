...
const stats = [
  { label: "Problems Solved", value: "42", icon: "task_alt", trend: "+12% this week", trendUp: true },
  { label: "Success Rate", value: "84%", icon: "percent", trend: "+5% vs avg", trendUp: true },
  { label: "Avg. Time / Problem", value: "24m", icon: "timer", trend: "-2m improvement", trendUp: false },
  { label: "Brainstorm Score", value: "780", icon: "psychology", trend: "Top 5%", trendUp: true },
];
...
const submissions = [
  { name: "Network Delay Time", difficulty: "medium" as const, language: "Python3", solved: true, date: "2 hours ago" },
  { name: "Valid Anagram", difficulty: "easy" as const, language: "Java", solved: true, date: "5 hours ago" },
  { name: "Median of Two Sorted Arrays", difficulty: "hard" as const, language: "C++", solved: false, date: "Yesterday" },
  { name: "Longest Palindromic Substring", difficulty: "medium" as const, language: "TypeScript", solved: true, date: "2 days ago" },
  { name: "Merge K Sorted Lists", difficulty: "hard" as const, language: "Go", solved: true, date: "3 days ago" },
];
    ...
    <div className="min-h-screen bg-background-light">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold tracking-tight text-slate-900">Google Hackathon</h2>
            </div>
      ...
      <main className="mx-auto max-w-6xl px-6 py-8 space-y-8">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Track your coding progress, accuracy, and technical growth.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
            <h3 className="text-slate-900 text-lg font-bold mb-6">Problems Solved Over Time</h3>
          ...
          {/* Topic Progress */}
          <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
            <h3 className="text-slate-900 text-lg font-bold mb-6">Performance by Topic</h3>
        ...
        <div className="rounded-xl bg-white border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-200">
            <h3 className="text-slate-900 text-lg font-bold">Recent Submissions</h3>
          </div>
              ...
              <tbody className="divide-y divide-slate-200">
                {submissions.map((sub) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm font-mono text-slate-600">{sub.language}</td>
                    <td className="px-6 py-4 text-sm">
                      {sub.solved ? (
